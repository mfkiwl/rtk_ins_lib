...
# C thumb sources
BUILD_CSOURCES:=$(foreach src,${PROJ_CSOURCES},${INS_LIB_ROOTDIR}/$(src))
BUILD_CPPSOURCES:=$(foreach src,${PROJ_CPPSOURCES},${INS_LIB_ROOTDIR}/$(src))

# C ARM sources
BUILD_CARMSOURCES:=$(foreach src,${PROJ_CARMSOURCES},${INS_LIB_ROOTDIR}/$(src))

# Assembly sources
BUILD_ASMSOURCES:=$(foreach src,${PROJ_ASMSOURCES},${INS_LIB_ROOTDIR}/$(src))
...
${TARGET}:  ${PROJ_COBJS}  ${PROJ_CPPOBJS}
	$(call MK_ECHO,Linking to $(subst ${INS_LIB_ROOTDIR}/,,$@))
