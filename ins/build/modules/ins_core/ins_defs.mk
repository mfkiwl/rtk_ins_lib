...
INS_C_SOURCES+= 					\
	...
	./src/lcinsupdate.c         	\
	./src/lcsystem.c      			\
	./src/loosecoupleset.c          \
	./src/matrix_wu.c         		\
	./src/orientation.c        		\
	./src/positionfilter.c 			\
	./src/rtkcmn.c  				\
	./src/zuptdetect.c   			
...
#	__CHAR_MAX__=0xff									\
	...
	__IAR_COMPILERBASE__=656898							\
	__IAR_COMPILERBASE_STR__=10.6.2.1213				\
	...
	__ICACHE_PRESENT=1									\
	__DCACHE_PRESENT=1									\
	-D_DLIB_CONFIG_FILE_HEADER_NAME="C:\\Program Files (x86)\\IAR Systems\\Embedded Workbench 8.3 EWARM FS 8.40.3\\arm\\inc\\c\\DLib_Config_Normal.h"	\
	-D_DLIB_CONFIG_FILE_STRING="C:\\Program Files (x86)\\IAR Systems\\Embedded Workbench 8.3 EWARM FS 8.40.3\\arm\\inc\\c\\DLib_Config_Normal.h"		\
	__VERSION__="IAR ANSI C/C++ Compiler V8.42.1.233/W32 for ARM"	\
	-D_VA_DEFINED=										\
	-D_VA_LIST=struct __va_list							\
	__ICCARM_OLD_DEFINED_VAARGS__=1						\
	__VA_STACK_ALIGN__=8								\
	__DATA_MEM0_SIZE_TYPE__=unsigned int													\
	__DATA_MEM0_INDEX_TYPE__=signed int														\
	__iar_fp2bits32(x)=0																	\
	__iar_fp2bits64(x)=0																	\
	__iar_fpgethi64(x)=0																	\
	__iar_atomic_add_fetch(x,y,z)=0															\
	__iar_atomic_sub_fetch(x,y,z)=0															\
	__iar_atomic_load(x,y)=0ULL																\
	__iar_atomic_compare_exchange_weak(a,b,c,d,e)=0											\
